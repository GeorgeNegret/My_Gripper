...
from launch_ros.descriptions import Parameter, ParameterValue
...
def launch_setup(context, *args, **kwargs):
    ...
    # UR + Gripper controllers
    ur_gripper_controllers = PathJoinSubstitution(
        [FindPackageShare(gripper_package), "config", "ur_wifi_gripper_controllers.yaml"]
    )
    # Gripper controllers
    wifi_gripper_controllers = PathJoinSubstitution(
        [FindPackageShare(gripper_package), "config", "wifi_gripper_controllers.yaml"]
    )
    control_node = Node(
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "gripper_package",
            default_value="wifi_gripper_driver",
            description="wifi gripper driver package .",
        )
    )
