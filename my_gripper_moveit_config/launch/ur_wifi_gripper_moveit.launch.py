...
from my_gripper_moveit_config.launch_common import load_yaml, load_yaml_abs
...
def launch_setup(context, *args, **kwargs):
    ...
    controllers_yaml = load_yaml("my_gripper_moveit_config", "config/controllers.yaml")
    # the scaled_joint_trajectory_controller does not work on fake hardware
    change_controllers = context.perform_substitution(use_fake_hardware)
    if change_controllers == "true":
        controllers_yaml["scaled_joint_trajectory_controller"]["default"] = False
        controllers_yaml["joint_trajectory_controller"]["default"] = True
        # controllers_yaml["scaled_joint_trajectory_controller_hand"]["default"] = False
        # controllers_yaml["joint_trajectory_controller_hand"]["default"] = True
    ...
    servo_yaml = load_yaml("my_gripper_moveit_config", "config/ur_wifi_gripper_servo.yaml")
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="Description package with UR robot URDF/XACRO files. Usually the argument \
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="Description package with UR robot + gripper URDF/XACRO files. Usually the argument \
        is not set, it enables use of a custom description.",
        )
    )
    declared_arguments.append(
